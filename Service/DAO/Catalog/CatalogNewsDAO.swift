...
class CatalogNewsDAO: CatalogAbstractItemDAO<CatalogNews> {

    override init(context: NSManagedObjectContext) {
        super.init(context: context)

        self.entityName = "CatalogNews"
    }
    
     override internal func entityToModel(_ entity: NSManagedObject) -> CatalogNews {
        return CatalogNews(
    ...
    override internal func applyModelToEntity(model: CatalogNews, entity: NSManagedObject) {
